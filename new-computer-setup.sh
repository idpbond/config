...
brew install tmux neovim wget fzf node git gpg the_silver_searcher redis awscli docker docker-compose hub tig htop pyenv coreutils alacritty shared-mime-info;
